...
def save_image(item):
    ...
    try:
        loca_image_url = item.get("image")
        new_image_url = loca_image_url.replace("list","large")
...
if __name__ == "__main__":
    pool = Pool()
    groups = ([x * 20 for x in range(GROUNP_START,GROUNP_END+1)])
